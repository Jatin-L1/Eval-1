...
const AboutUs = () => {
    ...
    return (
        <div className="about-container">
            ...
            {/* Who We Are Section */}
            <section id="about-us" className="container my-5 text-center text-white" data-aos="fade-up">
            ...
            <section id="team" className="container my-5 text-center" data-aos="fade-up">
            ...
            <section id="contact" className="parallax text-white py-5">
                <div className="container">
                    <h2 className="text-center">Get In Touch</h2>
                    <p className="text-center">We'd love to hear from you. Contact us today!</p>
                    <div className="row">
                        <div className="col-lg-6 mb-4">
                            <form id="contact-form" action="https://formspree.io/f/mrbgblkn" method="POST" onSubmit={handleSubmit}>
                                <div className="mb-3">
            ...
            {/* Back to Top Button */}
            <button id="back-to-top" title="Back to Top" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>⬆️</button>
        </div>
    );
};
